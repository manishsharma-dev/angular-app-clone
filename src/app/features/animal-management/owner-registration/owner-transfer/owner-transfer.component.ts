...
@Component({
  ...
  templateUrl: './owner-transfer.component.html',
  styleUrls: ['./owner-transfer.component.css'],
...
export class OwnerTransferComponent implements OnInit {
  ...
  fetchDetails(data: OrgList) {
    this.isOrgTabVisible = true;
    this.isAnimalTabVisible = true;
    this.selectedOrgName = data.Org_Name;
    for (let org of this.orgsList) {
      if (org.Org_Name == this.selectedOrgName) {
        this.selectedOrgAddress = org.Org_Address;
        this.selectedOrgRegNo = org.Reg_no;
      }
    }
  }
  ...
  editOwnerDialog(isView?: boolean) {
    const dialogRef = this.dialog.open(EditOwnerDetailsComponent, {
      data: {
        ...
        redirectLink: '/dashboard/owner/ownertransfer',
  ...
  openOtpDialog() {
    const dialogRef = this.dialog.open(OtpDialogComponent, {
      data: {
        ...
        link: '/dashboard/owner/ownertransfer',
